...
from finance.securities import SecurityFile, SecurityLoader, SecurityFilter
...
def main(*args, parameters, **kwargs):
    ...
    valuation_pipeline = security_reader + security_filter + strategy_calculator + valuation_calculator + valuation_filter + valuation_writer
